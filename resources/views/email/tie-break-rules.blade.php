                        ...
                        <td class="wrapper">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Hola!</p>
                                        <p>Se viene la fase de eliminatorias y con ella las definiciones por penales!</p>
                                        <p>Enterate como podés incrementar tus chances de sumar puntos</p>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td><a href="{{route('rules')}}" target="_blank">Ir al reglamento!</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
