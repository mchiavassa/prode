            ...
            <div>
                ...
                {this.props.tieBreakRequired === true &&
                    <div className={'bg-light'}>
                        ...
                        <div className={'row mt-1 collapse ' + ((this.state.homeTieBreakScore === '' || this.state.homeTieBreakScore === null) && (this.state.awayTieBreakScore === '' || this.state.awayTieBreakScore === null) ? '' : 'show')} id={'tiebox-' + this.props.gameId}>
